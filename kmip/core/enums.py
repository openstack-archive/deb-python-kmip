...
class DigitalSignatureAlgorithm(enum.Enum):
    ...
    SHA_1_WITH_RSA_ENCRYPTION   = 0x00000003
    SHA_224_WITH_RSA_ENCRYPTION = 0x00000004
    SHA_256_WITH_RSA_ENCRYPTION = 0x00000005
    SHA_384_WITH_RSA_ENCRYPTION = 0x00000006
    SHA_512_WITH_RSA_ENCRYPTION = 0x00000007
    RSASSA_PSS                  = 0x00000008
    DSA_WITH_SHA_1              = 0x00000009
    DSA_WITH_SHA_224            = 0x0000000A
    DSA_WITH_SHA_256            = 0x0000000B
    ECDSA_WITH_SHA_1            = 0x0000000C
    ECDSA_WITH_SHA_224          = 0x0000000D
    ECDSA_WITH_SHA_256          = 0x0000000E
    ECDSA_WITH_SHA_384          = 0x0000000F
    ECDSA_WITH_SHA_512          = 0x00000010
...
class ValidityIndictor(enum.Enum):
    """
    """
    VALID   = 0x00000001
    INVALID = 0x00000002
